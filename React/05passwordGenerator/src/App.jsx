...
const copyPasswordToClipboard = useCallback(()=>{
 ...
 passwordGenerator();
  ...
  return (
    ...
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-3 my-8 text-orange-500 bg-gray-800 pb-4'>
    <h1 className='text-2xl text-white font-bold text-center py-4 my-3'>Password Generator</h1>
